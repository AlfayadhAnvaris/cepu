...
{{-- @if (Route::currentRouteName()=== 'user.all.complaints')
  @section('title', 'Semua Pengaduan')
@elseif (Route::currentRouteName()=== 'user.all.pending.complaints')
  @section('title', 'Semua Pengaduan Pending')
@elseif (Route::currentRouteName()=== 'user.all.process.complaints')
   @section('title', 'Semua Pengaduan Proses')
@elseif (Route::currentRouteName()=== 'user.all.success.complaints')
                        ...
                        <table class="table table-striped" id="myTable">
                            ...
                            <tbody>
                                ...
                                {{-- <tr>
                                    ...
                                    <td>John Doe</td>
                                    <td>Pengadu Kebersihan</td>
                                    <td><span class="badge bg-succes">Selesai</span></td>
